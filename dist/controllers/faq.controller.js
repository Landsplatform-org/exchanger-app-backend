...
exports.deleteFAQ = exports.updateFAQ = exports.addFAQ = exports.getFAQById = exports.getFAQs = void 0;
const faq_model_1 = require("../models/faq.model");
const faqs = new faq_model_1.FAQ();
const getFAQs = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const page = req.query.page ? req.query.page : "0";
    const limit = req.query.limit ? req.query.limit : "10";
    try {
        const result = yield faqs.getAll(limit, page);
...
const getFAQById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const result = yield faqs.getById(id);
        return res.status(200).send({
            status: 200,
            data: result,
            message: "Successful",
...
const addFAQ = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!bodyToAdd)
        return;
    try {
        const result = yield faqs.add(bodyToAdd);
...
const updateFAQ = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!bodyToUpdate)
        return;
    try {
        const result = yield faqs.update(id, bodyToUpdate);
        return res.status(200).send({
            status: 200,
            data: result,
            message: "Successful",
...
const deleteFAQ = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    try {
        const result = yield faqs.delete(id);
        return res.status(200).send({
            status: 200,
            data: result,
            message: "Successful",
